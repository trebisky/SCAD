 ...
 * I measure carefully and see 0.205, but the
 * corners are a bit rounded.
 * I remeasure the slot and get 0.185
 */
// bite_l = mm ( 0.20 );
bite_l = mm ( 0.180 );
...
module slab () {
 	difference () {
		translate ( [ -big1, half, up ] )
			cube ( [ big2, slice, big1 ] );
		bite ();
	}
}
